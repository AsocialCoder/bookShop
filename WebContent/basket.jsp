...
String baskettid = request.getParameter("basketID");
if(delete != null)
{
	db.deletebasket(userid, Integer.parseInt(delete),Integer.parseInt(baskettid));
}

try {
	stmt =conn.createStatement();
	String sql;
	sql ="SELECT * FROM books INNER JOIN basket ON books.bookID=basket.bookID where basket.userID ='"+userid+"'";
	...
	<a href="basket.jsp?delete=<%= id %>&basketID=<%= basketid %>" target="_self"><div class="bookDetailButtonDiv">DELETE</div></a>
...
<h1 style="width: 100%;text-align: center">Price: <%=sumprice%> PLN</h1>
